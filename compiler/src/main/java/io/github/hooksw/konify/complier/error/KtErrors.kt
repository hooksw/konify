 ...
 */
package io.github.hooksw.konify.complier.error
...
internal object KtErrors {
  val VIEW_MUST_BE_CALLED_INSIDE_VIEW by
    error0<PsiElement>(SourceElementPositioningStrategies.NAME_IDENTIFIER)
  val OVERRIDDEN_FUNCTION_SHOULD_HAVE_VIEW_ANNOTATION by
    error0<PsiElement>(SourceElementPositioningStrategies.NAME_IDENTIFIER)
  val SUSPEND_FUNCTION_IS_NOT_SUPPORTED by
    error0<PsiElement>(SourceElementPositioningStrategies.NAME_IDENTIFIER)
