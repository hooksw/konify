...
internal class DeepCopyIrTreeWithRemappedComposableTypes(
    ...
    private val symbolRemapper: DeepCopySymbolRemapper = DeepCopySymbolRemapper(),
    ...
    override fun visitSimpleFunction(declaration: IrSimpleFunction): IrSimpleFunction {
        if (declaration.symbol.isRemappedAndBound()) {
            return declaration.symbol.owner
        }
    ...
    override fun visitCall(expression: IrCall): IrCall {
        ...
        if (
            ...
            val newFnClass = context.irBuiltIns.functionN(realParams)
    ...
    private fun IrType.isComposable(): Boolean {
        return annotations.hasAnnotation(Annotations.Component.asSingleFqName())
    }
}
...
class ComposerTypeRemapper(
    ...
    private fun IrType.isComposableFunction(): Boolean {
        return isSyntheticComposableFunction() || (isFunction() && hasAnnotation(Annotations.Component.asSingleFqName()))
    }
    ...
    override fun remapType(type: IrType): IrType {
        ...
        val functionCls = context.irBuiltIns.functionN(oldIrArguments.size-1).symbol
    ...
    private fun remapTypeArgument(typeArgument: IrTypeArgument): IrTypeArgument =
        if (typeArgument is IrTypeProjection)
            ...
            typeArgument.typeOrFail.lazyType(context) as IrTypeArgument
...
private fun IrConstructorCall.isComposableAnnotation() =
    this.symbol.owner.parent.fqNameForIrSerialization == Annotations.Component.asSingleFqName()
